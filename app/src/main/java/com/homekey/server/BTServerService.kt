...
//        const val ACTION_DEVICE_CONNECTED = "com.example.com.com.com.homekey.server.ACTION_DEVICE_CONNECTED"
//        // Random UUID for our service known between the client and server to allow communication
//        val SERVICE_UUID: UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"); // SPP UUID
//        const val SERVICE_NAME: String = "MyBluetoothService"
